...
const global = {
  ...
  api: {
    apiKey: "95b87a2d278008a6737c449466944488",
...
const fetchPopularTvShow = async () => {
  ...
  console.log(` *** POPULAR TV SHOW :${data}  *** `);
...
//serach shows and movies

const serachShowsandTvDetails = async () => {
  const queryString = window.location.search;
  const urlParams = new URLSearchParams(queryString);
  console.log(urlParams);
  global.search.type = urlParams.get("type");
  global.search.term = urlParams.get("search-term");
  console.log("Type : " + global.search.type);
  console.log("Term : " + global.search.term);
